"""MiniFASNet architecture, vendored from the original Silent-Face-Anti-Spoofing
repo (minivision-ai/Silent-Face-Anti-Spoofing, src/model_lib/MiniFASNet.py,
MIT-licensed) so app/models/liveness.py can load the authors' pretrained
`.pth` checkpoints. Architecture code only — no weights are embedded here.
"""
import torch
